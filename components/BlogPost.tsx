...
export function BlogPost({slug}: BlogPostProps) {
  ...
  const jsonLd = {
    ...
    image: mdxData.ogImage ? `https://www.AmazingTier.com${mdxData.ogImage}` : undefined,
  };
  ...
  return {
    ...
    openGraph: {
      ...
      images: mdxData.ogImage ? [
        {
          url: `https://www.AmazingTier.com${mdxData.ogImage}`,
          width: 1200,
          height: 630,
          alt: mdxData.title,
        }
        ...
        {
          url: 'https://www.AmazingTier.com/opengraph-image.png',
          width: 1200,
          height: 630,
          alt: 'AmazingTier',
        },
    ...
    twitter: {
      ...
      title: mdxData.title,
      description: mdxData.description,
      images: mdxData.ogImage ? [`https://www.AmazingTier.com${mdxData.ogImage}`] : undefined,
    },
    alternates: {
      canonical: `https://www.AmazingTier.com/blog/${slug}`,
    },
