      ...
      <div className="relative w-screen left-1/2 right-1/2 -mx-[50vw] bg-primary text-primary-foreground">
        <section className="py-20 max-w-screen-lg mx-auto px-4">
          ...
          <p className="text-xl leading-relaxed mb-6">
            I started AmazingTier with a simple goal: to make tier list creation fun, free, and accessible.
          ...
          <div className="flex flex-col md:grid md:grid-cols-3 gap-8">
            <Card className="col-span-3">
              ...
              <CardContent className="space-y-2">
                <p className="text-lg">
                  AmazingTier takes a unique approach to tier list creation. Instead of relying on a centralized
                ...
                <p className="text-lg">
                  ...
                  fork the project. We <i>truly</i> value your help and contributions to AmazingTier.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20">
        <Card className="bg-primary text-primary-foreground p-4">
          ...
          <CardContent className="text-center px-8">
            <p className="text-xl leading-relaxed">
              Join us in shaping the future of AmazingTier, making it the go-to tool for creating tier lists.
            </p>
            <p className="text-sm text-muted mb-8">
              And who knows? Your contributions could shape not just AmazingTier, but potentially spark ideas for more
              open-source tools in the future.
            </p>
            <div className="flex justify-center space-x-4 mb-6">
              <Button variant="secondary" asChild>
                <a href="https://github.com/infinia-yzl/AmazingTier" className="flex items-center space-x-2"
                   aria-label="GitHub">
